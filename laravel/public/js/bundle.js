...
$(function () {
  ...
  $('.notification .delete').on('click', function (e) {
    return $(e.target).parent().fadeOut();
  });
  $('.featured-photos a').toArray().forEach(function (a) {
    $('#' + a.id).on('click', function (e) {
      e.preventDefault();

      if (!$(e.currentTarget).hasClass('featured')) {
        $('.featured-photos a').toArray().forEach(function (a) {
          return $('#' + a.id).removeClass('featured');
        });
  ...
  $('#website-address-modal-close').on('click', function (e) {
    e.preventDefault();
...
__webpack_require__(/*! /Users/nima/Work/RobotKudos/PropertySpot/propertyspot.net/laravel/resources/js/app.js */"./resources/js/app.js");
module.exports = __webpack_require__(/*! /Users/nima/Work/RobotKudos/PropertySpot/propertyspot.net/laravel/resources/scss/main.scss */"./resources/scss/main.scss");
